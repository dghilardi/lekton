...
LKN_DATABASE__URI=mongodb://localhost:27017
LKN_DATABASE__NAME=lekton

# S3 Storage Configuration
LKN_STORAGE__BUCKET=lekton-docs
LKN_STORAGE__ENDPOINT=http://localhost:3900
AWS_ACCESS_KEY_ID=$ACCESS_KEY
AWS_SECRET_ACCESS_KEY=$SECRET_KEY
AWS_REGION=garage

# Service Token for API ingestion
LKN_AUTH__SERVICE_TOKEN=demo-ingest-token

# Meilisearch Configuration
LKN_SEARCH__URL=http://localhost:7700
LKN_SEARCH__API_KEY=dev-master-key-change-in-prod
