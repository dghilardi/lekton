    ...
    view! {
        ...
        <html lang="en" data-theme="light">
            <head>
                ...
                {cfg!(feature = "mermaid").then(|| view! { <script src="/js/mermaid-loader.js"></script> })}
            </head>
            <body>
                <App />
            </body>
...
/// Server function to get Meilisearch re-index status.
...
/// Server function to trigger a Meilisearch re-index (admin only).
...
pub async fn get_doc_html(
    ...
    let Some(doc) = doc else {
        ...
        if children.is_empty() {
            // No direct children — check for descendants to handle virtual folder paths
            // (e.g., "docs" containing "docs/microservices/page" with no direct "docs/page" document)
